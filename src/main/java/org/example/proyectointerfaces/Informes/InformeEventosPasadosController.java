...
public class InformeEventosPasadosController {
    ...
    @FXML
    private DatePicker fechaPasadaDatePicker;
    ...
    public void initialize() {
        // Restringir el DatePicker para que solo permita fechas pasadas
        fechaPasadaDatePicker.setDayCellFactory(new Callback<DatePicker, DateCell>() {
            @Override
            public DateCell call(DatePicker datePicker) {
                return new DateCell() {
                    ...
                    public void updateItem(LocalDate item, boolean empty) {
                        ...
                        if (item.isAfter(LocalDate.now().minusDays(1))) { // Solo fechas pasadas
                            setDisable(true);
    ...
    private void generarInforme() {
        ...
        LocalDate fechaPasada = fechaPasadaDatePicker.getValue();
        ...
        String fechaPasadaStr = fechaPasada.format(formatter);

        System.out.println("Generando informe para la fecha pasada: " + fechaPasadaStr);
        ...
        try (Connection con = Conexion.getConexion()) {
            ...
            parametros.put("FechaPasada", fechaPasadaStr);
